             ...
             dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    ...
    if ((self = [super init]))
    {
        ...
        NSString *privateQueueName = [NSString stringWithFormat:@"com.suning.rmweaktimertarget.%p", self];
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    RMWeakTimerTarget *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                           target:target
                                                         selector:selector
                                                         userInfo:userInfo
                                                          repeats:repeats
...
- (void)schedule
{
    ...
    __weak RMWeakTimerTarget *weakSelf = self;
